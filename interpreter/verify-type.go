...
func parseRuntimeType(t tokens.Token, env *environment.Environment) (types.UmbraType, ast.EnumStatement, error) {
	...
	case tokens.IDENTIFIER:
		...
		if !ok {
			return types.UNKNOWN, ast.EnumStatement{}, exception.NewRuntimeError("RT002", "", t.Lexeme)
		}
		...
		return types.UNKNOWN, ast.EnumStatement{}, exception.NewRuntimeError("RT035", "", t.Lexeme)
	default:
