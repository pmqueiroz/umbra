...
func readFile(args []interface{}) (interface{}, error) {
	...
	if err != nil {
		return "", exception.NewRuntimeError("RT032", nil, "read", path)
	}
...
func writeFile(args []interface{}) (interface{}, error) {
	...
	if err != nil {
		return nil, exception.NewRuntimeError("RT032", nil, "write", path)
	}
...
func deleteFile(args []interface{}) (interface{}, error) {
	...
	if err != nil {
		return nil, exception.NewRuntimeError("RT032", nil, "delete", path)
	}
